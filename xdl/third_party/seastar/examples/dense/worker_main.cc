...
int main(int ac, char* as[])
{
    ...
    sprintf(args[2], "--user_threads_num=%d", userThreadNum);
    ...
    //serverAddrsBak.push_back(std::make_tuple(4, "127.0.0.1:17004"));
    //serverAddrsBak.push_back(std::make_tuple(5, "127.0.0.1:17005"));
    //serverAddrsBak.push_back(std::make_tuple(6, "127.0.0.1:17006"));
    //serverAddrsBak.push_back(std::make_tuple(7, "127.0.0.1:17007"));

    serverAddrsBak.push_back(std::make_tuple(0, "10.101.200.223:17000"));
    serverAddrsBak.push_back(std::make_tuple(1, "10.101.200.223:17001"));
    serverAddrsBak.push_back(std::make_tuple(2, "10.101.200.223:17002"));
    serverAddrsBak.push_back(std::make_tuple(3, "10.101.200.223:17003"));
    //serverAddrsBak.push_back(std::make_tuple(4, "10.101.200.223:17004"));
    //serverAddrsBak.push_back(std::make_tuple(5, "10.101.200.223:17005"));
    //serverAddrsBak.push_back(std::make_tuple(6, "10.101.200.223:17006"));
    //serverAddrsBak.push_back(std::make_tuple(7, "10.101.200.223:17007"));
    //serverAddrsBak.push_back(std::make_tuple(8, "10.101.200.223:17008"));
    //serverAddrsBak.push_back(std::make_tuple(9, "10.101.200.223:17009"));
    //serverAddrsBak.push_back(std::make_tuple(10, "10.101.200.223:17010"));
    //serverAddrsBak.push_back(std::make_tuple(11, "10.101.200.223:17011"));
    //serverAddrsBak.push_back(std::make_tuple(12, "10.101.200.223:17012"));
    //serverAddrsBak.push_back(std::make_tuple(13, "10.101.200.223:17013"));
    //serverAddrsBak.push_back(std::make_tuple(14, "10.101.200.223:17014"));
    //serverAddrsBak.push_back(std::make_tuple(15, "10.101.200.223:17015"));
    //serverAddrsBak.push_back(std::make_tuple(16, "10.101.200.223:17016"));
    //serverAddrsBak.push_back(std::make_tuple(17, "10.101.200.223:17017"));
    //serverAddrsBak.push_back(std::make_tuple(18, "10.101.200.223:17018"));
    //serverAddrsBak.push_back(std::make_tuple(19, "10.101.200.223:17019"));
    //serverAddrsBak.push_back(std::make_tuple(20, "10.101.200.223:17020"));
    //serverAddrsBak.push_back(std::make_tuple(21, "10.101.200.223:17021"));
    //serverAddrsBak.push_back(std::make_tuple(22, "10.101.200.223:17022"));
    //serverAddrsBak.push_back(std::make_tuple(23, "10.101.200.223:17023"));
    ...
    boost::thread cncThread(boost::ref(cnc), 3, args, serverAddrs);

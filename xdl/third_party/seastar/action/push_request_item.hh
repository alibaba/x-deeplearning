#ifndef PS_ACTION_ACTION_PUSH_REQUEST_ITEM_H
#define PS_ACTION_ACTION_PUSH_REQUEST_ITEM_H
...
template<typename T>
class PushRequestItem : public ps::network::SeastarWorkItem
{
public:
    PushRequestItem(ps::network::ClientNetworkContext& cnc, int32_t user,
    ...
    seastar::future<> Run() override
    {
        ...
        ps::action::UpdateRequestSerializer<T>* serializer
            = new ps::action::UpdateRequestSerializer<T>(kSource, kBegin, kEnd, mShardKey);
...
#endif // PS_ACTION_ACTION_PUSH_REQUEST_ITEM_H

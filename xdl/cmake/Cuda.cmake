...
# Known NVIDIA GPU achitectures xdl can be compiled for.
# This list will be used for CUDA_ARCH_NAME = All option
if(${CUDA_VERSION} GREATER 7.5)
  set(xdl_known_gpu_archs "30 35 50 52 60 61")
else()
  set(xdl_known_gpu_archs "30 35 50 52")
endif()
...
# Usage:
#   xdl_detect_installed_gpus(out_variable)
function(xdl_detect_installed_gpus out_variable)
  if(NOT CUDA_gpu_detect_output)
    ...
    if(__nvcc_res EQUAL 0)
      ...
      set(CUDA_gpu_detect_output ${__nvcc_out} CACHE INTERNAL "Returned GPU architetures from xdl_detect_gpus tool" FORCE)
    else()
  ...
  if(NOT CUDA_gpu_detect_output)
    message(WARNING "Automatic GPU detection failed. Building for all known architectures (${xdl_known_gpu_archs}).")
    set(${out_variable} ${xdl_known_gpu_archs} PARENT_SCOPE)
  else()
...
# Usage:
#   xdl_select_nvcc_arch_flags(out_variable)
function(xdl_select_nvcc_arch_flags out_variable)
  # List of arch names
  ...
  if(${CUDA_ARCH_NAME} STREQUAL "Manual")
    set(CUDA_ARCH_BIN ${xdl_known_gpu_archs} CACHE STRING "Specify 'real' GPU architectures to build binaries for, BIN(PTX) format is supported")
  ...
  set(__cuda_arch_bin ${xdl_known_gpu_archs})
  ...
  xdl_list_unique(__cuda_arch_bin __cuda_arch_ptx)
...
# Usage:
#   xdl_cuda_compile(<objlist_variable> <cuda_files>)
macro(xdl_cuda_compile objlist_variable)
...
list(APPEND xdl_LINKER_LIBS ${CUDA_CUDART_LIBRARY}
...
if(USE_CUDNN)
  ...
  if(HAVE_CUDNN)
    ...
    list(APPEND xdl_LINKER_LIBS ${CUDNN_LIBRARY})
  endif()
endif()

# setting nvcc arch flags
xdl_select_nvcc_arch_flags(NVCC_FLAGS_EXTRA)
...
if(APPLE)
  xdl_detect_darwin_version(OSX_VERSION)
  ...
  if(OSX_VERSION VERSION_GREATER 10.8)
    ...
    xdl_option(USE_libstdcpp "Use libstdc++ instead of libc++" (CUDA_VERSION VERSION_LESS 7.0))
  endif()
endif()

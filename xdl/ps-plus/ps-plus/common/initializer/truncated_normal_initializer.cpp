...
bool TruncatedNormalInitializer::Accept(DataType type) {
...
void TruncatedNormalInitializer::Init(void* data, 
                                      DataType type, 
                                      size_t size) {
  int seed1 = 0;
  int seed2 = 0;
...
Initializer* TruncatedNormalInitializer::Clone() {
  return new TruncatedNormalInitializer(seed_, 
                                        mean_, 
                                        stddev_);
}

...
template <typename T>
class PsSparseApplyAdagradOp : public xdl::OpKernelAsync {
 public:
...
XDL_DEFINE_OP(PsSparseApplyAdagradOp)
...
DEFINE_INT_OP(XDL_REGISTER_KERNEL(PsSparseApplyAdagradOp, PsSparseApplyAdagradOp<T>)
              .Device("CPU")

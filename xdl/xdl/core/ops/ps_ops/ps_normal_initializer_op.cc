...
class PsNormalInitializerOp : public xdl::OpKernelAsync {
 public:
  ...
  void Compute(OpKernelContext* ctx, Callback done) override {
    ...
    ps::Initializer* initializer = 
      new ps::initializer::NormalInitializer(
          seed_, mean_, stddev_);
    switch (var_type_) {
    case VarType::kIndex:
...
XDL_DEFINE_OP(PsNormalInitializerOp)
...
XDL_REGISTER_KERNEL(PsNormalInitializerOp, PsNormalInitializerOp)
  .Device("CPU");

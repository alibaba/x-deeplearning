...
TEST(TestInOrder, All) {
  CheckPatternOutput(
      "./utest_data/graph/pattern/in_parallel/parallel_split_matmul_fusion.blaze",
      "./utest_data/graph/pattern/in_parallel/parallel_split_matmul_fusion_expected.blaze");
}
